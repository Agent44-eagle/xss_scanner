...
from module import load_payloads, load_urls, scanner_xss, analysis_response, scanner_Dom_advanced

colorama_init(autoreset=True)

def main():
    parser = argparse.ArgumentParser(description="Sonik XSS Scanner (Threaded + Advanced DOM)")
    ...
    parser.add_argument("-t", "--threads", type=int, default=10, help="Number of worker threads")
    ...
    print(Fore.GREEN + "[~] Starting Advanced DOM-based analysis..." + Style.RESET_ALL)
    scanner_Dom_advanced(urls)
